...
public class FirstpageFormController extends Application implements Initializable {
    ...
    public void managesupplierbtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/managesupplier_form.fxml"));
        Parent root1 = null;
        try {
        ...
        Stage currentStage = (Stage) managesupplierbtn.getScene().getWindow();
        currentStage.close();
    }

    public void manageemployeebtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/manageemployee_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
    ...
    public void managematerialbtnbtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/managematerial_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
        ...
        Stage currentStage = (Stage) managematerialbtn.getScene().getWindow();
        currentStage.close();
    }

    public void manageclothesbtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/manageclothes_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
        ...
        Stage currentStage = (Stage) manageclothesbtn.getScene().getWindow();
        currentStage.close();
    }

    public void manageorderbtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/manageorder_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
        ...
        Stage currentStage = (Stage) manageorderbtn.getScene().getWindow();
        currentStage.close();
    }

    public void managecustomerbtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/managecustomer_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
        ...
        Stage currentStage = (Stage) managecustomerbtn.getScene().getWindow();
        currentStage.close();
    }

    public void managepaybtnonaction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/view/managepayment_form.fxml"));
        Parent root1 = null;
        try {
            root1 = (Parent) fxmlLoader.load();
        } catch (IOException e) {
        ...
        Stage currentStage = (Stage) managepaybtn.getScene().getWindow();
        currentStage.close();
    }
    ...
    public void miccommand(String voiceCommand, LiveSpeechRecognizer speech){
        if (voiceCommand.equalsIgnoreCase("MATERIAL")) {
            ...
            Stage currentStage = (Stage) micbtn.getScene().getWindow();
            currentStage.close();
